...
//        checkIfFirstAndLastIsOne();
//        checkIfThereIsABinaryGap();
//        calculateBinaryGap();
//        findTheLongestBinaryGap();


    }

    private void generateNumbersSet() {
    }

    private void findTheLongestBinaryGap() {
    }

    private void calculateBinaryGap() {
    }

    private void checkIfThereIsABinaryGap() {
    }

    private void checkIfFirstAndLastIsOne() {
    }
